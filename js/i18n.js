...
const UI = {
  "pt-BR": {
    ...
    projectLinks: { live: "Ver ao vivo ↗", repo: "Código ↗", details: "Ver detalhes →" },
    noteLink: "Ler artigo completo ↗",
    satelliteLabel: "Satélite Z2A",
  ...
  en: {
    ...
    projectLinks: { live: "View live ↗", repo: "Code ↗", details: "See details →" },
    noteLink: "Read the full paper ↗",
    satelliteLabel: "Z2A Satellite",
  ...
  es: {
    ...
    projectLinks: { live: "Ver en vivo ↗", repo: "Código ↗", details: "Ver detalles →" },
