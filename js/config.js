...
const CONFIG = {
  "pt-BR": {
    ...
    aboutParagraphs: [
      ...
      "Minha atuação técnica é guiada por uma filosofia de Just-in-Time Learning, onde o estudo não é um fim em si mesmo, mas uma ferramenta pragmática de execução para resolver desafios de arquitetura e negócios. Com a base formal em sistemas estabelecida e consolidando a Engenharia de Software, opero hoje na trincheira do desenvolvimento de soluções Full-Cycle, conectando a lógica de microsserviços em nuvem às rigorosas regras de negócios e compliance.",
      "Para sustentar a escalabilidade e a governança de projetos complexos, meu plano de aprimoramento contínuo avança em duas frentes simultâneas. Na frente de mercado, sigo um roadmap estruturado de chancelas executivas e operacionais, englobando gestão de serviços (PSM I, ITIL 4, Lean Six Sigma), infraestrutura de redes seguras (CCNA) e orquestração e arquitetura em nuvem (AWS Solutions Architect/Security e CKA).",
      "Já na fronteira acadêmica, minha visão de longo prazo é aplicar o mais alto rigor científico para embasar ecossistemas corporativos. Esse caminho está projetado para avançar por um Mestrado Profissional em Computação de Missão Crítica (FIEMG/ITA) e culminar em um Doutorado Industrial europeu, visando polos de pesquisa aplicada como o Politecnico di Milano ou a Fraunhofer-Gesellschaft. O propósito deste ecossistema de pesquisa não é puramente acadêmico, mas sim a validação intercontinental de frameworks proprietários de arquitetura Zero-Trust e processamento distribuído diretamente em infraestruturas industriais reais. Meu objetivo final é garantir que o conhecimento tecnológico profundo seja sempre traduzido em expansão de mercado, segurança institucional e mitigação absoluta de riscos operacionais.",
    ],
  },
  en: {
    ...
    aboutParagraphs: [
      ...
      "My technical practice is guided by a 'Just-in-Time Learning' philosophy, where study is not an end in itself but a pragmatic execution tool for solving architectural and business challenges. With a solid formal foundation in systems and a strong background in Software Engineering, I currently operate on the front lines of full-cycle solution development, bridging cloud-based microservices logic with rigorous business and compliance rules.",
      "To support the scalability and governance of complex projects, my continuous improvement plan advances on two simultaneous fronts. On the market front, I follow a structured roadmap of executive and operational certifications, covering service management (PSM I, ITIL 4, Lean Six Sigma), secure network infrastructure (CCNA), and cloud orchestration and architecture (AWS Solutions Architect/Security and CKA).",
      "On the academic front, my long-term vision is to apply the highest level of scientific rigor to underpin corporate ecosystems. This path is designed to progress through a Professional Master’s in Mission-Critical Computing (FIEMG/ITA) and culminate in a European Industrial Doctorate, targeting applied research hubs such as Politecnico di Milano or the Fraunhofer-Gesellschaft. The purpose of this research ecosystem is not purely academic; rather, it aims for the intercontinental validation of proprietary Zero-Trust architecture and distributed processing frameworks directly within real-world industrial infrastructures. My ultimate goal is to ensure that deep technological knowledge consistently translates into market expansion, institutional security, and the absolute mitigation of operational risks."
    ],
  },
  es: {
    ...
    aboutParagraphs: [
      ...
      "Mi actuación técnica está guiada por una filosofía de Aprendizaje Justo a Tiempo, donde el estudio no es un fin en sí mismo, sino una herramienta pragmática de ejecución para resolver desafíos de arquitectura y negocios. Con la base formal en sistemas establecida y consolidando la Ingeniería de Software, opero hoy en la trinchera del desarrollo de soluciones Full-Cycle, conectando la lógica de microservicios en la nube con las rigurosas reglas de negocios y cumplimiento.",
      "Para sustentar la escalabilidad y la gobernanza de proyectos complejos, mi plan de mejora continua avanza en dos frentes simultáneos. En el frente de mercado, sigo una hoja de ruta estructurada de certificaciones ejecutivas y operativas, abarcando gestión de servicios (PSM I, ITIL 4, Lean Six Sigma), infraestructura de redes seguras (CCNA) y orquestación y arquitectura en la nube (AWS Solutions Architect/Security y CKA).",
      "Ya en la frontera académica, mi visión a largo plazo es aplicar el más alto rigor científico para respaldar ecosistemas corporativos. Este camino está proyectado para avanzar por una Maestría Profesional en Computación de Misión Crítica (FIEMG/ITA) y culminar en un Doctorado Industrial europeo, apuntando a polos de investigación aplicada como el Politecnico di Milano o la Fraunhofer-Gesellschaft. El propósito de este ecosistema de investigación no es puramente académico, sino la validación intercontinental de frameworks propietarios de arquitectura Zero-Trust y procesamiento distribuido directamente en infraestructuras industriales reales. Mi objetivo final es garantizar que el conocimiento tecnológico profundo se traduzca siempre en expansión de mercado, seguridad institucional y mitigación absoluta de riesgos operativos.",
    ],
  },
};
