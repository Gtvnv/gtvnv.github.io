...
const CONFIG = {
  ...
  en: {
    ...
    aboutParagraphs: [
      ...
      "My long-term goal is to consolidate this practical and academic experience in a master's in Computer Science, digging deeper into platform architecture. In the meantime, I keep working with the awareness of someone who understands the \"shop floor\": iterating fast and learning by revisiting my own decisions.",
    ],
  },
  es: {
    ...
    aboutParagraphs: [
      ...
      "Mi objetivo a largo plazo es consolidar esta vivencia práctica y académica en una maestría en Ciencias de la Computación, profundizando aún más en arquitectura de plataformas. Mientras tanto, sigo trabajando con la conciencia de quien entiende el \"piso de fábrica\": iterando rápido y aprendiendo al revisar mis propias decisiones.",
    ],
  },
};
